...
class AutomaticCamerasConnectionPage extends StatefulWidget {
  const AutomaticCamerasConnectionPage({super.key});
          ...
          children: [
            ...
            const Padding(
              ...
              child: TitleWithSubTitle(
                ...
                subTitle:
                    "Foram identificadas X câmeras na sua rede de internet. Agora, iremos tentar estabelecer uma conexão com elas de forma automática.",
              ),
            ),
            Padding(
